...
TEXTS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "btn_cancel": "❌ Cancel",
        "sent": "Sent 👍",
        "send_failed": "Couldn't send it: {error}\nTap Send to try again.",
    ...
    "tr": {
        ...
        "btn_cancel": "❌ Vazgeç",
        "sent": "Gönderdim 👍",
        "send_failed": "Gönderemedim: {error}\nGönder'e bir daha bas, tekrar deneyeyim.",
    ...
    "de": {
        ...
        "sent": "Gesendet 👍",
        "send_failed": "Konnte nicht senden: {error}\nTipp nochmal auf Senden.",
