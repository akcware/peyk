...
TEXTS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "card_not_yours": "That card isn't yours, nothing happened",
        "ack_sent": "Sent",
    ...
    "tr": {
        ...
        "card_not_yours": "Bu kart sana ait değil, bir şey yapılmadı",
        "ack_sent": "Gönderildi",
    ...
    "de": {
        ...
        "card_not_yours": "Diese Karte gehört dir nicht, es ist nichts passiert",
        "ack_sent": "Gesendet",
