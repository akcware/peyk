...
TABLES = ("app_user", "chat_state", "memory", "scheduled_job", "triage", "sent_notification", "mute_rule", "budget_settings", "identity", "person", "action", "source_cursor", "observation")
...
def settings(test_db_url: str) -> Settings:
    return Settings(
        ...
        CHAT_BUBBLE_PAUSE_S=0,      # tests: bubbles go out back to back
    )
